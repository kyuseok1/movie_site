...
OPEN TMDB API를 활용한 영화, TV 프로그램을 간단하게 볼 수 있는 웹페이지입니다. 이 사이트는 axios를 사용해 인기, 평점, 장르를 기준으로 영화와 TV 프로그램에 대한 정보를 얻을 수 있고 `Express와` `Node.js`, `MongoDB`를 활용한 로그인 및 회원가입 기능이 있습니다.
